// Analysis — pre-launch waitlist. A blurred preview of the live Analysis
// dashboard sits behind a frictionless glass waitlist card.
...
export function AnalysisScreen({ waitlistSubmitted, onSubmitWaitlist }) {
