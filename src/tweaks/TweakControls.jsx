...
// Form-control helpers for the Tweaks panel — segmented radios, sliders,
// steppers, toggles, color/palette pickers. Styling lives in TweaksPanel's
// injected stylesheet (.twk-* classes).
...
// rest stacked in a sharp column on the right. onChange emits the option in
// the shape it was passed. Without options it falls back to the native color
